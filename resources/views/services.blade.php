...
<li><a class="font-body-md text-body-md text-white/70 hover:text-secondary-container transition-colors duration-200 font-light" href="{{ route('privacy-policy') }}">Politică de Confidențialitate</a></li>
</ul>
</div>
</div>
</footer>
